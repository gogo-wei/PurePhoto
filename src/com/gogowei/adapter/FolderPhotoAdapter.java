...
public class FolderPhotoAdapter extends BaseAdapter{
	private Context mContext;
	private List<PhotoBean> mDatas;
	private LayoutInflater mInflater;
	
	public FolderPhotoAdapter (Context context ,List<PhotoBean> datas){
		mContext = context;
		this.mDatas = datas;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageLoader.getInstance().loadImage(bean.getPath(), holder.photoView);
